...
const { APP_SECRET, EXCHANGE_NAME, CUSTOMER_SERVICE, MSG_QUEUE_URL, USER_CREATED } = require("../config");
//Utility functions
...
module.exports.CreateChannel = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(err, "---CHANNEL DOWN---");
        throw err;
    }
});
module.exports.PublishMessage = (channel, bindingKey, msg) => __awaiter(void 0, void 0, void 0, function* () {
...
module.exports.SubscribeMessage = (channel, service, bindingKey) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const q = yield channel.assertQueue("UserQueue");
